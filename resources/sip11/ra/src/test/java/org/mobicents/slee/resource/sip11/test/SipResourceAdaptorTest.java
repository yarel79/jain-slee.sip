...
public class SipResourceAdaptorTest {
	...
	// miniaml mock just to satify SipResourceAdaptor's usage of the tracer
	...
	@Test
	/* Purpose of this test it to verify whether two RA can be activated on the same network interface within same class loader */ 
	public void activateTwoRa() {
		...
		configRa1.addProperty(new Property("org.mobicents.ha.javax.sip.LoadBalancerHeartBeatingServiceClassName","java.lang.String","org.mobicents.ha.javax.sip.LoadBalancerHeartBeatingServiceImpl"));
		configRa1.addProperty(new Property("org.mobicents.ha.javax.sip.LoadBalancerElector","java.lang.String","org.mobicents.ha.javax.sip.RoundRobinLoadBalancerElector"));
		configRa1.addProperty(new Property("org.mobicents.ha.javax.sip.CACHE_CLASS_NAME","java.lang.String","org.mobicents.ha.javax.sip.cache.NoCache"));
